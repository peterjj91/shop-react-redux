...
export const FETCH_CATEGORIES_START = 'FETCH_PHONES_BY_ID_START'
export const FETCH_CATEGORIES_SUCCESS = 'FETCH_PHONES_BY_ID_SUCCESS'
export const FETCH_CATEGORIES_FAILURE = 'FETCH_PHONES_BY_ID_FAILURE'
